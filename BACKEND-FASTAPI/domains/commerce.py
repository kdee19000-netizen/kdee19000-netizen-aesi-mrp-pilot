...
class CommerceSafetyDomain:
    ...
    def get_risk_patterns() -> Dict[CommerceRiskType, List[str]]:
        return {
            CommerceRiskType.SCAM: [
                "sent money but no product", "fake seller", "won't refund",
                "never received", "took my money", "obvious scam"
            ],
            CommerceRiskType.FRAUD: [
                "unauthorized charges", "didn't make this purchase",
                "credit card fraud", "someone used my account"
            ],
            ...
            CommerceRiskType.UNSAFE_PRODUCT: [
                ...
                "dangerous defect", "safety hazard", "recall"
            ],
            CommerceRiskType.IDENTITY_THEFT: [
                "used my identity", "opened account in my name",
                "stolen personal info", "fake account"
            ]
        }
    ...
    def get_safe_response(risk_type: CommerceRiskType) -> str:
        responses = {
            CommerceRiskType.FRAUD:
                "I'm flagging this transaction immediately and freezing your account for protection. "
                "Our fraud team will contact you within 1 hour. "
                "You will not be responsible for unauthorized charges.",

            CommerceRiskType.SCAM:
                "Thank you for reporting this. I'm documenting this case for our fraud investigation team. "
                "We'll work to recover your funds and prevent this seller from targeting others. "
                "Case number: [AUTO-GENERATED]",

            CommerceRiskType.THREATENING_CUSTOMER:
                "This behavior violates our terms of service and potentially criminal law. "
            ...
            CommerceRiskType.UNSAFE_PRODUCT:
                "This is a serious safety concern. I'm immediately flagging this product and "
