...
class PublicSafetyDomain:
    ...
    def get_safe_response(risk_type: PublicSafetyRiskType) -> str:
        responses = {
            PublicSafetyRiskType.CRISIS: "🚨 If you are in immediate danger, call 911 now. "
            "I am creating an urgent case for emergency services. "
            "Help is being dispatched. Stay on the line if you can.",
            PublicSafetyRiskType.DOMESTIC_VIOLENCE: "You are not alone, and this is not your fault. Your safety is most important. "
            "National Domestic Violence Hotline: 1-800-799-7233. "
            "Would you like me to connect you with local resources and a safe place to go?",
            PublicSafetyRiskType.HOMELESSNESS: "I'm connecting you with emergency housing resources. "
            ...
            PublicSafetyRiskType.CHILD_ENDANGERMENT: "Thank you for reporting this. Children's safety is our highest priority. "
    ...
    def get_mandatory_reporters() -> List[PublicSafetyRiskType]:
        ...
        return [PublicSafetyRiskType.CHILD_ENDANGERMENT, PublicSafetyRiskType.ELDER_ABUSE, PublicSafetyRiskType.CRISIS]
